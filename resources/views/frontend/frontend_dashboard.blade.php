                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="title-text">
                                        <h4>
                                            <a href="">${value.property.property_name}</a>
                                        </h4>
                                    </div>
                    ...
                    $.each(response, function(key, value) {
                        rows +=
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="submit" class="custom_compare_remove text-body" id="${value.id}" onclick="compareRemove(this.id)" ><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            `
                    });
