                            ...
                            <div class="widget-content">
                                ...
                                <div class="select-box">
                                    <select class="wide" name="property_status">
                                        <option data-display="Select Status" selected="" disabled="">
                                            Select Status
                                        </option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="propertyType_id">
                                        <option data-display="Select Type" selected="" disabled="">
                                            Select Type
                                        </option>
                                        @foreach ($propertyTypes as $propertyType)
                                            <option value="{{ $propertyType->type_name }}">
                                ...
                                <div class="select-box">
                                    <select class="wide" name="state_id">
                                        <option data-display="Select State" selected="" disabled="">
                                            Select State
                                        </option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="bedrooms">
                                        <option data-display="Select Bedrooms" selected="" disabled="">
                                            Select Bedrooms
                                        </option>
                                ...
                                <div class="select-box">
                                    <select class="wide" name="bathrooms">
                                        <option data-display="Select Bathrooms" selected="" disabled="">
                                            Select Bathrooms
                                        </option>
                ...
                <div class="property-content-side">
                    ...
                    <div class="item-shorting clearfix">
                        ...
                        <div class="left-column pull-left">
                            <h5>Search Reasults: <span>Showing {{ count($properties_data) }} Listings</span></h5>
                        </div>
                    ...
                    <div class="wrapper list">
                        ...
                        <div class="deals-list-content list-item">
                            ...
                            @foreach ($properties_data as $item)
                    ...
                    <div class="pagination-wrapper">
                        {{ $properties_data->links('vendor.pagination.custom') }}
                    </div>
