                    ...
                    <div class="property-details-content">
                        ...
                        <div class="location-box content-widget">
                            ...
                            <ul class="info clearfix">
                                ...
                                <li><span>State/county:</span> {{ $property['propertyState']['state_name'] }}</li>
                                <li><span>Neighborhood:</span> {{ $property->neighborhood }}</li>
                                <li><span>Zip/Postal Code:</span> 2{{ $property->postal_code }}</li>
                        ...
                        <div class="statistics-box content-widget">
                            ...
                            <figure class="image-box">
                                <iframe width="100%" height="415" src="{{ $property->property_video }}"
