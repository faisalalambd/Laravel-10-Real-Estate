                        ...
                        <form id="myForm" method="post" action="{{ route('store.property') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 mb-3">
                                    ...
                                    <input type="file" name="multi_img[]" class="form-control mb-2" id="multiImg"
                                        multiple="">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <label class="form-label">Agent <span style="color: rgb(168, 0, 0);">(Don't choose
                                            anything if you're an admin)</span></label>
                            ...
                            <button type="submit" class="btn btn-outline-primary me-2 mt-4">Save Changes </button>
